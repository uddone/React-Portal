...
function bubbleChart() {
  ...
  const fillColour = d3.scaleOrdinal()
    .domain(["C","D","E","F","I","J","L","M","N","P","R","S","T","U","V","W"])
    .range(["#CCD5AE","#E9EDC9","#FEFAE0","#FAEDCD","#FFACAC","#FFBFA9","#FFEBB4","#FBFFB1","#B2A4FF","#FFB4B4","#FFDEB4","#FDF7C3","#EDF1D6","#9DC08B","#609966","#40513B"]);
...
// /assets/csv/bubble.json
// load data
lsobj = localStorage.getItem('gogo_current_user');
...
formData2.append('ur', ur2)
url2 = 'http://localhost:8080/RBServer'
url2 +='/ln/main'
...
body : formData2
    ...
    let temp2 = temp1.POS_ANALY
    temp2 = JSON.parse(temp2)
    temp2 = temp2.chartdata
