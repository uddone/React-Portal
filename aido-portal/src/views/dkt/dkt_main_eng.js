...
import { lineeng,radareng,} from 'data/chartsdkt';
import profileStatuses from 'data/profileStatusesdkt_eng';
import Sankeychart from 'views/dkt/sankey';
import data from 'data/iconCardsdkt_eng';
      ...
      <Row>
          ...
          <Card>
            ...
            <CardTitle style={{
              ...
              <div className="chart-container">
                    <RadarChart shadow data={radareng} />
                  </div>
            </CardBody>
              {/* conversionChartData */}
          </Card>
        ...
        <Colxx xl="4" lg="6" md="12" className="mb-4">
          <Card>
            ...
            <div className="chart-container">
                    <LineChartdkt shadow data={lineeng} />
                  </div>
            </CardBody>
              {/* conversionChartData */}
          </Card>
